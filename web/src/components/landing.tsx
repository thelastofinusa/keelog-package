...
import { SiPnpm, SiNpm, SiBun, SiYarn } from "react-icons/si";
...
const packageIcons = {
  npm: <SiNpm aria-hidden />,
  pnpm: <SiPnpm aria-hidden />,
  bun: <SiBun aria-hidden />,
  yarn: <SiYarn aria-hidden />,
...
export function Landing(props: Landing.Props) {
  ...
  return (
    <div className="vocs:relative vocs:left-1/2 vocs:z-50 vocs:mt-[calc(-1*var(--vocs-spacing-banner)-var(--vocs-spacing-content-py))] vocs:mb-[calc(-1*var(--vocs-spacing-content-py))] vocs:flex vocs:h-[100svh] vocs:w-screen vocs:-translate-x-1/2 vocs:flex-col vocs:overflow-hidden vocs:bg-primary vocs:text-heading vocs:max-[700px]:h-auto vocs:max-[700px]:min-h-[100svh] vocs:max-[700px]:overflow-visible">
            ...
            >
              {logoUrl && typeof logoUrl === "string" && (
                <img
                  src={logoUrl}
                  alt={config.title}
                  className="vocs:h-6 vocs:w-auto"
                />
              )}
              {logoUrl && typeof logoUrl !== "string" && (
                <>
      ...
      <main className="vocs:relative vocs:flex vocs:min-h-0 vocs:flex-1 vocs:items-center vocs:pb-10 vocs:pt-6 vocs:max-[700px]:items-start vocs:max-[700px]:pb-8">
        <div className="vocs:mx-auto vocs:w-full vocs:max-w-[900px] vocs:px-8 vocs:max-[700px]:px-5">
          <section className="vocs:w-[min(100%,700px)]">
            <h1 className="vocs:m-0 vocs:mb-[18px] vocs:text-[clamp(40px,5.6vw,68px)] vocs:font-semibold vocs:leading-[0.96] vocs:tracking-[-0.025em] vocs:text-heading vocs:max-[700px]:text-[clamp(40px,12vw,44px)]">
              {title}
            </h1>
            <p className="vocs:m-0 vocs:mb-8 vocs:text-xl vocs:leading-[1.6] vocs:text-secondary vocs:max-w-xl vocs:max-[700px]:text-[17px]">
              {description}
            </p>
            ...
            <div className="vocs:mb-4 vocs:w-[min(100%,620px)] vocs:overflow-hidden vocs:rounded-[var(--vocs-radius-lg)] vocs:border vocs:border-solid vocs:border-primary vocs:bg-surface vocs:max-[700px]:w-full">
              ...
              >
                <code className="vocs:font-mono vocs:text-base vocs:text-accent">
                  <span className="vocs:text-muted">{runner}</span>{" "}
                  {args.join(" ")}
                </code>
                <span
